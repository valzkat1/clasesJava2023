...
import vistas.JFrameVistaLogin;
import vistas.JFrameVistaFormularioAgregar;
import vistas.JFrameVistaFormularioVer;
...
public class Controlador {
    ...
    private Repositorio model;

    public void iniciar() {
        this.model = new Repositorio();
